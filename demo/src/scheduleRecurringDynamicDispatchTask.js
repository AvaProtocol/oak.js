...
async function main() {
  ...
  const executionTimes = _.map(getHourlyRecurringTimestamps(new Date().valueOf(), 1), (time) => time / 1000);
  const schedule = { recurring: { nextExecutionTime: executionTimes[0], frequency: 3600 }};
