...
declare module '@polkadot/api-base/types/errors' {
  interface AugmentedErrors<ApiType extends ApiTypes> {
    ...
    automationPrice: {
       ...
       **/
      AssetAlreadySupported: AugmentedError<ApiType>;
      /**
       ...
       **/
      AssetNotInTriggerableRange: AugmentedError<ApiType>;
      /**
       * Non existent asset
       **/
       ...
       **/
      InvalidAssetExpirationWindow: AugmentedError<ApiType>;
      /**
    ...
    automationTime: {
       ...
       **/
      TimeTooFarOut: AugmentedError<ApiType>;
      /**
    ...
    valve: {
       ...
       **/
      CannotCloseGate: AugmentedError<ApiType>;
      /**
       ...
       **/
      ScheduledTasksAlreadyRunnung: AugmentedError<ApiType>;
      /**
       * Scheduled tasks have already been stopped.
       **/
      ScheduledTasksAlreadyStopped: AugmentedError<ApiType>;
      /**
       * The valve is already closed.
       **/
      ValveAlreadyClosed: AugmentedError<ApiType>;
      /**
       * The valve is already open.
       **/
      ValveAlreadyOpen: AugmentedError<ApiType>;
      /**
       * Generic error
       **/
      [key: string]: AugmentedError<ApiType>;
    ...
    xcmpHandler: {
       ...
       **/
      ErrorGettingCallWeight: AugmentedError<ApiType>;
      /**
       * Failed to send XCM to target.
       **/
      ErrorSendingXcmToTarget: AugmentedError<ApiType>;
      /**
