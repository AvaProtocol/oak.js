...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  interface RpcInterface {
    ...
    automationTime: {
       ...
       **/
      calculateOptimalAutostaking: AugmentedRpc<(principal: i128, collator: AccountId | string | Uint8Array) => Observable<AutostakingResult>>;
      /**
       ...
       **/
      getTimeAutomationFees: AugmentedRpc<(action: AutomationAction, executions: u32) => Observable<Balance>>;
      /**
    ...
    contracts: {
       ...
       **/
      instantiate: AugmentedRpc<(request: InstantiateRequestV1, at?: BlockHash | string | Uint8Array) => Observable<ContractInstantiateResult>>;
      /**
    ...
    eth: {
       ...
       **/
      getTransactionCount: AugmentedRpc<(address: H160 | string | Uint8Array, number?: BlockNumber) => Observable<U256>>;
      /**
    ...
    mmr: {
       ...
       **/
      generateProof: AugmentedRpc<(blockNumbers: Vec<u64>, bestKnownBlockNumber?: u64, at?: BlockHash | string | Uint8Array) => Observable<MmrLeafBatchProof>>;
      /**
       ...
       * Verify an MMR proof
       **/
      verifyProof: AugmentedRpc<(proof: MmrLeafBatchProof) => Observable<bool>>;
      /**
       * Verify an MMR proof statelessly given an mmr_root
       **/
      verifyProofStateless: AugmentedRpc<(root: MmrHash | string | Uint8Array, proof: MmrLeafBatchProof) => Observable<bool>>;
    };
    net: {
      /**
    ...
    xcmpHandler: {
       ...
       **/
      crossChainAccount: AugmentedRpc<(accountId: AccountId32 | string | Uint8Array) => Observable<AccountId32>>;
      /**
       * Determine fees for a scheduled xcmp task
       **/
      fees: AugmentedRpc<(encodedXt: Bytes | string | Uint8Array) => Observable<u64>>;
    };
  } // RpcInterface
} // declare module
