...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    PalletAutomationTimeMissedTask: PalletAutomationTimeMissedTask;
    ...
    TuringRuntimeCurrencyId: TuringRuntimeCurrencyId;
