...
declare module '@polkadot/types/lookup' {
  ...
  /** @name OrmlAssetRegistryModuleEvent (37) */
  ...
  /** @name OrmlTraitsAssetRegistryAssetMetadata (38) */
  ...
  /** @name PrimitivesAssetsCustomMetadata (39) */
  ...
  /** @name XcmV2MultiLocation (45) */
  interface XcmV2MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV2MultilocationJunctions;
  }

  /** @name XcmV2MultilocationJunctions (46) */
  ...
  /** @name XcmV3JunctionNetworkId (59) */
  ...
  /** @name PalletParachainStakingEvent (63) */
  ...
  /** @name PalletParachainStakingDelegationRequestsCancelledScheduledRequest (65) */
  ...
  /** @name PalletParachainStakingDelegationRequestsDelegationAction (66) */
  ...
  /** @name PalletParachainStakingDelegatorAdded (67) */
  ...
  /** @name XcmV2MultiassetFungibility (115) */
  ...
  /** @name XcmV2MultiassetAssetInstance (116) */
  ...
  /** @name OrmlXtokensModuleEvent (119) */
  ...
  /** @name PalletDemocracyVoteThreshold (130) */
  ...
  /** @name PalletDemocracyVoteAccountVote (131) */
  ...
  /** @name PalletDemocracyMetadataOwner (133) */
  ...
  /** @name PalletMultisigTimepoint (135) */
  interface PalletMultisigTimepoint extends Struct {
    readonly height: u32;
    readonly index: u32;
  }

  /** @name PalletAutomationTimeEvent (136) */
  interface PalletAutomationTimeEvent extends Enum {
    readonly isTaskScheduled: boolean;
    readonly asTaskScheduled: {
      readonly who: AccountId32;
      readonly taskId: Bytes;
      readonly scheduleAs: Option<AccountId32>;
    } & Struct;
    ...
    readonly isTaskRescheduleFailed: boolean;
    readonly asTaskRescheduleFailed: {
      readonly who: AccountId32;
      readonly taskId: Bytes;
      readonly error: SpRuntimeDispatchError;
    } & Struct;
    ...
    readonly isTaskTriggered: boolean;
    readonly asTaskTriggered: {
      readonly who: AccountId32;
      readonly taskId: Bytes;
      readonly condition: BTreeMap<Bytes, Bytes>;
      readonly encodedCall: Option<Bytes>;
    } & Struct;
    readonly isTaskExecuted: boolean;
    readonly asTaskExecuted: {
      readonly who: AccountId32;
      readonly taskId: Bytes;
    } & Struct;
    readonly isTaskExecutionFailed: boolean;
    readonly asTaskExecutionFailed: {
      readonly who: AccountId32;
      readonly taskId: Bytes;
      readonly error: SpRuntimeDispatchError;
    } & Struct;
    readonly type: 'TaskScheduled' | 'TaskCancelled' | 'TaskNotFound' | 'TaskMissed' | 'TaskRescheduled' | 'TaskNotRescheduled' | 'TaskRescheduleFailed' | 'TaskCompleted' | 'TaskTriggered' | 'TaskExecuted' | 'TaskExecutionFailed';
  }

  /** @name PalletVestingEvent (142) */
  ...
  /** @name PalletXcmpHandlerEvent (143) */
  interface PalletXcmpHandlerEvent extends Enum {
    ...
    readonly type: 'XcmSent' | 'XcmTransactedLocally' | 'XcmFeesPaid' | 'XcmFeesFailed' | 'TransactInfoChanged' | 'TransactInfoRemoved';
  }

  /** @name PalletAutomationPriceEvent (144) */
  interface PalletAutomationPriceEvent extends Enum {
    ...
    readonly asTaskTriggered: {
      readonly ownerId: AccountId32;
      readonly taskId: Bytes;
      readonly condition: PalletAutomationPriceTaskCondition;
    } & Struct;
    readonly isTaskExecuted: boolean;
    readonly asTaskExecuted: {
      readonly ownerId: AccountId32;
    ...
    readonly isTaskExpired: boolean;
    readonly asTaskExpired: {
      readonly ownerId: AccountId32;
      readonly taskId: Bytes;
      readonly condition: PalletAutomationPriceTaskCondition;
    } & Struct;
    readonly isTaskSweep: boolean;
    readonly asTaskSweep: {
      readonly ownerId: AccountId32;
      readonly taskId: Bytes;
      readonly condition: PalletAutomationPriceTaskCondition;
    } & Struct;
    readonly isPriceAlreadyMoved: boolean;
    readonly asPriceAlreadyMoved: {
      readonly ownerId: AccountId32;
      readonly taskId: Bytes;
      readonly condition: PalletAutomationPriceTaskCondition;
    } & Struct;
    ...
    readonly asAssetCreated: {
      ...
      readonly exchange: Bytes;
      readonly asset1: Bytes;
      readonly asset2: Bytes;
      readonly decimal: u8;
    } & Struct;
    ...
    readonly type: 'TaskScheduled' | 'TaskTriggered' | 'TaskExecuted' | 'TaskExecutionFailed' | 'TaskCompleted' | 'TaskCancelled' | 'TaskNotFound' | 'TaskExpired' | 'TaskSweep' | 'PriceAlreadyMoved' | 'AssetCreated' | 'AssetUpdated' | 'AssetDeleted';
  }

  /** @name PalletAutomationPriceTaskCondition (145) */
  interface PalletAutomationPriceTaskCondition extends Enum {
    readonly isTargetPriceMatched: boolean;
    readonly asTargetPriceMatched: {
      readonly chain: Bytes;
      readonly exchange: Bytes;
      readonly assetPair: ITuple<[Bytes, Bytes]>;
      readonly price: u128;
    } & Struct;
    readonly isAlreadyExpired: boolean;
    readonly asAlreadyExpired: {
      readonly expiredAt: u128;
      readonly now: u128;
    } & Struct;
    readonly isPriceAlreadyMoved: boolean;
    readonly asPriceAlreadyMoved: {
    ...
    readonly type: 'TargetPriceMatched' | 'AlreadyExpired' | 'PriceAlreadyMoved';
  }
  ...
  /** @name PolkadotPrimitivesV4PersistedValidationData (165) */
  ...
  /** @name PolkadotPrimitivesV4UpgradeRestriction (168) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot (171) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotRelayDispachQueueSize (172) */
  interface CumulusPalletParachainSystemRelayStateSnapshotRelayDispachQueueSize extends Struct {
    readonly remainingCount: u32;
    readonly remainingSize: u32;
  }

  /** @name PolkadotPrimitivesV4AbridgedHrmpChannel (175) */
  ...
  /** @name PolkadotPrimitivesV4AbridgedHostConfiguration (177) */
  ...
  /** @name PolkadotCorePrimitivesOutboundHrmpMessage (183) */
  interface PolkadotCorePrimitivesOutboundHrmpMessage extends Struct {
    readonly recipient: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemCodeUpgradeAuthorization (184) */
  interface CumulusPalletParachainSystemCodeUpgradeAuthorization extends Struct {
    readonly codeHash: H256;
    readonly checkVersion: bool;
  }

  /** @name CumulusPalletParachainSystemCall (185) */
  ...
  /** @name CumulusPrimitivesParachainInherentParachainInherentData (186) */
  ...
  /** @name PolkadotCorePrimitivesInboundDownwardMessage (188) */
  interface PolkadotCorePrimitivesInboundDownwardMessage extends Struct {
    readonly sentAt: u32;
    readonly msg: Bytes;
  }

  /** @name PolkadotCorePrimitivesInboundHrmpMessage (191) */
  interface PolkadotCorePrimitivesInboundHrmpMessage extends Struct {
    readonly sentAt: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemError (194) */
  ...
  /** @name PalletBalancesIdAmount (204) */
  ...
  /** @name OrmlTokensBalanceLock (213) */
  interface OrmlTokensBalanceLock extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensAccountData (215) */
  ...
  /** @name OrmlTokensReserveData (217) */
  interface OrmlTokensReserveData extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensModuleError (219) */
  ...
  /** @name OrmlCurrenciesModuleCall (220) */
  ...
  /** @name OrmlCurrenciesModuleError (222) */
  ...
  /** @name PalletTransactionPaymentReleases (224) */
  ...
  /** @name OrmlAssetRegistryModuleCall (225) */
  ...
  /** @name OrmlAssetRegistryModuleError (229) */
  ...
  /** @name TuringRuntimeSessionKeys (232) */
  interface TuringRuntimeSessionKeys extends Struct {
    readonly aura: SpConsensusAuraSr25519AppSr25519Public;
  }

  /** @name SpConsensusAuraSr25519AppSr25519Public (233) */
  interface SpConsensusAuraSr25519AppSr25519Public extends SpCoreSr25519Public {}

  /** @name SpCoreSr25519Public (234) */
  ...
  /** @name PalletParachainStakingParachainBondConfig (240) */
  interface PalletParachainStakingParachainBondConfig extends Struct {
    readonly account: AccountId32;
    readonly percent: Percent;
  }

  /** @name PalletParachainStakingRoundInfo (241) */
  ...
  /** @name PalletParachainStakingDelegator (242) */
  ...
  /** @name PalletParachainStakingCandidateMetadata (247) */
  ...
  /** @name PalletParachainStakingCapacityStatus (248) */
  ...
  /** @name PalletParachainStakingCandidateBondLessRequest (250) */
  interface PalletParachainStakingCandidateBondLessRequest extends Struct {
    readonly amount: u128;
    readonly whenExecutable: u32;
  }

  /** @name PalletParachainStakingCollatorStatus (251) */
  ...
  /** @name PalletParachainStakingDelegationRequestsScheduledRequest (253) */
  ...
  /** @name PalletParachainStakingBondWithAutoCompound (265) */
  ...
  /** @name PalletParachainStakingDelayedPayout (266) */
  ...
  /** @name PalletParachainStakingInflationInflationInfo (267) */
  ...
  /** @name PalletParachainStakingCall (270) */
  ...
  /** @name PalletParachainStakingError (271) */
  ...
  /** @name PalletIdentityRegistration (277) */
  ...
  /** @name PalletIdentityIdentityInfo (282) */
  ...
  /** @name PalletIdentityBitFlags (322) */
  ...
  /** @name PalletIdentityIdentityField (323) */
  ...
  /** @name PalletProxyProxyDefinition (330) */
  ...
  /** @name PalletProxyAnnouncement (334) */
  ...
  /** @name TuringRuntimeOriginCaller (341) */
  ...
  /** @name CumulusPalletXcmOrigin (344) */
  ...
  /** @name CumulusPalletXcmpQueueCall (348) */
  ...
  /** @name XcmV2MultiassetMultiAssetFilter (358) */
  ...
  /** @name XcmV2MultiassetWildMultiAsset (359) */
  ...
  /** @name XcmV2MultiassetWildFungibility (360) */
  ...
  /** @name CumulusPalletDmpQueueCall (370) */
  ...
  /** @name OrmlXtokensModuleCall (371) */
  ...
  /** @name XcmVersionedMultiAsset (372) */
  ...
  /** @name FrameSupportPreimagesBounded (384) */
  ...
  /** @name PalletDemocracyConviction (386) */
  ...
  /** @name PalletAutomationTimeCall (389) */
  interface PalletAutomationTimeCall extends Enum {
    ...
    readonly asScheduleXcmpTask: {
      ...
      readonly destination: XcmVersionedMultiLocation;
      readonly scheduleFee: XcmVersionedMultiLocation;
      readonly executionFee: PalletAutomationTimeAssetPayment;
      readonly encodedCall: Bytes;
      readonly encodedCallWeight: SpWeightsWeightV2Weight;
      readonly overallWeight: SpWeightsWeightV2Weight;
    } & Struct;
    readonly isScheduleXcmpTaskThroughProxy: boolean;
    readonly asScheduleXcmpTaskThroughProxy: {
      readonly schedule: PalletAutomationTimeScheduleParam;
      readonly destination: XcmVersionedMultiLocation;
      readonly scheduleFee: XcmVersionedMultiLocation;
      readonly executionFee: PalletAutomationTimeAssetPayment;
      ...
      readonly encodedCallWeight: SpWeightsWeightV2Weight;
      readonly overallWeight: SpWeightsWeightV2Weight;
      readonly scheduleAs: AccountId32;
    } & Struct;
    ...
    readonly isCancelTaskWithScheduleAs: boolean;
    readonly asCancelTaskWithScheduleAs: {
      readonly ownerId: AccountId32;
      readonly taskId: Bytes;
    } & Struct;
    readonly type: 'ScheduleXcmpTask' | 'ScheduleXcmpTaskThroughProxy' | 'ScheduleAutoCompoundDelegatedStakeTask' | 'ScheduleDynamicDispatchTask' | 'CancelTask' | 'ForceCancelTask' | 'CancelTaskWithScheduleAs';
  }

  /** @name PalletAutomationTimeScheduleParam (390) */
  ...
  /** @name PalletAutomationTimeAssetPayment (392) */
  interface PalletAutomationTimeAssetPayment extends Struct {
    readonly assetLocation: XcmVersionedMultiLocation;
    readonly amount: u128;
  }

  /** @name PalletXcmpHandlerCall (393) */
  type PalletXcmpHandlerCall = Null;

  /** @name PalletAutomationPriceCall (394) */
  interface PalletAutomationPriceCall extends Enum {
    readonly isInitializeAsset: boolean;
    readonly asInitializeAsset: {
      readonly chain: Bytes;
      readonly exchange: Bytes;
      readonly asset1: Bytes;
      readonly asset2: Bytes;
      readonly decimal: u8;
      readonly assetOwners: Vec<AccountId32>;
    } & Struct;
    readonly isUpdateAssetPrices: boolean;
    readonly asUpdateAssetPrices: {
      readonly chains: Vec<Bytes>;
      readonly exchanges: Vec<Bytes>;
      readonly assets1: Vec<Bytes>;
      readonly assets2: Vec<Bytes>;
      readonly prices: Vec<u128>;
      readonly submittedAt: Vec<u128>;
      readonly rounds: Vec<u128>;
    } & Struct;
    ...
    readonly asScheduleXcmpTask: {
      ...
      readonly asset2: Bytes;
      readonly expiredAt: u128;
      readonly triggerFunction: Bytes;
      readonly triggerParam: Vec<u128>;
      readonly destination: XcmVersionedMultiLocation;
      readonly scheduleFee: XcmVersionedMultiLocation;
      readonly executionFee: PalletAutomationPriceAssetPayment;
      readonly encodedCall: Bytes;
      readonly encodedCallWeight: SpWeightsWeightV2Weight;
      readonly overallWeight: SpWeightsWeightV2Weight;
    } & Struct;
    ...
    readonly asScheduleXcmpTaskThroughProxy: {
      ...
      readonly expiredAt: u128;
      readonly triggerFunction: Bytes;
      readonly triggerParams: Vec<u128>;
      readonly destination: XcmVersionedMultiLocation;
      readonly scheduleFee: XcmVersionedMultiLocation;
      readonly executionFee: PalletAutomationPriceAssetPayment;
      readonly encodedCall: Bytes;
    ...
    readonly type: 'InitializeAsset' | 'UpdateAssetPrices' | 'DeleteAsset' | 'ScheduleXcmpTask' | 'ScheduleXcmpTaskThroughProxy' | 'CancelTask';
  }

  /** @name PalletAutomationPriceAssetPayment (396) */
  interface PalletAutomationPriceAssetPayment extends Struct {
    readonly assetLocation: XcmVersionedMultiLocation;
    readonly amount: u128;
  }
  ...
  /** @name CumulusPalletXcmpQueueInboundChannelDetails (400) */
  ...
  /** @name CumulusPalletXcmpQueueInboundState (401) */
  ...
  /** @name PolkadotParachainPrimitivesXcmpMessageFormat (404) */
  ...
  /** @name CumulusPalletXcmpQueueQueueConfigData (410) */
  ...
  /** @name PalletXcmVersionMigrationStage (422) */
  ...
  /** @name CumulusPalletDmpQueueConfigData (434) */
  interface CumulusPalletDmpQueueConfigData extends Struct {
    readonly maxIndividual: SpWeightsWeightV2Weight;
  }

  /** @name CumulusPalletDmpQueuePageIndexData (435) */
  ...
  /** @name CumulusPalletDmpQueueError (438) */
  ...
  /** @name OrmlXtokensModuleError (439) */
  ...
  /** @name OrmlUnknownTokensModuleError (442) */
  ...
  /** @name PalletBountiesBountyStatus (455) */
  ...
  /** @name PalletPreimageRequestStatus (458) */
  ...
  /** @name PalletSchedulerScheduled (466) */
  ...
  /** @name PalletDemocracyReferendumInfo (473) */
  ...
  /** @name PalletDemocracyReferendumStatus (474) */
  ...
  /** @name PalletDemocracyVoteVoting (476) */
  ...
  /** @name PalletDemocracyDelegations (480) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (481) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (484) */
  ...
  /** @name PalletAutomationTimeScheduledTasks (488) */
  interface PalletAutomationTimeScheduledTasks extends Struct {
    readonly tasks: Vec<ITuple<[AccountId32, Bytes]>>;
    readonly weight: u128;
  }

  /** @name PalletAutomationTimeTask (491) */
  interface PalletAutomationTimeTask extends Struct {
    ...
    readonly abortErrors: Vec<Bytes>;
  }

  /** @name PalletAutomationTimeSchedule (492) */
  ...
  /** @name PalletAutomationTimeAction (493) */
  interface PalletAutomationTimeAction extends Enum {
    readonly isXcmp: boolean;
    readonly asXcmp: {
      readonly destination: XcmV3MultiLocation;
      readonly scheduleFee: XcmV3MultiLocation;
      readonly executionFee: PalletAutomationTimeAssetPayment;
      readonly encodedCall: Bytes;
      readonly encodedCallWeight: SpWeightsWeightV2Weight;
      readonly overallWeight: SpWeightsWeightV2Weight;
      readonly scheduleAs: Option<AccountId32>;
      readonly instructionSequence: PalletXcmpHandlerInstructionSequence;
    } & Struct;
    ...
    readonly type: 'Xcmp' | 'AutoCompoundDelegatedStake' | 'DynamicDispatch';
  }

  /** @name PalletXcmpHandlerInstructionSequence (494) */
  interface PalletXcmpHandlerInstructionSequence extends Enum {
    readonly isPayThroughSovereignAccount: boolean;
    readonly isPayThroughRemoteDerivativeAccount: boolean;
    readonly type: 'PayThroughSovereignAccount' | 'PayThroughRemoteDerivativeAccount';
  }

  /** @name PalletAutomationTimeMissedTaskV2 (496) */
  ...
  /** @name PalletAutomationTimeError (498) */
  interface PalletAutomationTimeError extends Enum {
    ...
    readonly isTaskScheduleAsNotMatch: boolean;
    readonly isBlockTimeNotSet: boolean;
    readonly isInsufficientBalance: boolean;
    readonly isLiquidityRestrictions: boolean;
    readonly isTooManyExecutionsTimes: boolean;
    readonly isCallCannotBeDecoded: boolean;
    readonly isIncoveribleCurrencyId: boolean;
    readonly isBadVersion: boolean;
    readonly isUnsupportedFeePayment: boolean;
    readonly isCannotReanchor: boolean;
    readonly isInvalidAssetLocation: boolean;
    readonly type: 'InvalidTime' | 'PastTime' | 'TimeTooFarOut' | 'DuplicateTask' | 'TimeSlotFull' | 'TaskDoesNotExist' | 'TaskScheduleAsNotMatch' | 'BlockTimeNotSet' | 'InsufficientBalance' | 'LiquidityRestrictions' | 'TooManyExecutionsTimes' | 'CallCannotBeDecoded' | 'IncoveribleCurrencyId' | 'BadVersion' | 'UnsupportedFeePayment' | 'CannotReanchor' | 'InvalidAssetLocation';
  }

  /** @name PalletVestingError (500) */
  interface PalletVestingError extends Enum {
    readonly isBlockTimeNotSet: boolean;
    readonly type: 'BlockTimeNotSet';
  }

  /** @name PalletXcmpHandlerError (501) */
  interface PalletXcmpHandlerError extends Enum {
    ...
    readonly isBadVersion: boolean;
    readonly isTransactInfoNotFound: boolean;
    readonly isInvalidAssetLocation: boolean;
    readonly isUnsupportedFeePayment: boolean;
    readonly type: 'FeeOverflow' | 'WeightOverflow' | 'FailedMultiLocationToJunction' | 'CannotReanchor' | 'ErrorSendingXcmToTarget' | 'XcmExecutionFailed' | 'ErrorGettingCallWeight' | 'BadVersion' | 'TransactInfoNotFound' | 'InvalidAssetLocation' | 'UnsupportedFeePayment';
  }

  /** @name PalletAutomationPriceRegistryInfo (503) */
  interface PalletAutomationPriceRegistryInfo extends Struct {
    readonly round: u128;
    readonly decimal: u8;
    readonly lastUpdate: u64;
    readonly oracleProviders: Vec<AccountId32>;
  }

  /** @name PalletAutomationPricePriceData (504) */
  interface PalletAutomationPricePriceData extends Struct {
    readonly round: u128;
    readonly updatedAt: u128;
    readonly value: u128;
  }

  /** @name PalletAutomationPriceTask (515) */
  ...
  /** @name PalletAutomationPriceAction (516) */
  ...
  /** @name PalletAutomationPriceStatType (517) */
  interface PalletAutomationPriceStatType extends Enum {
    readonly isTotalTasksOverall: boolean;
    readonly isTotalTasksPerAccount: boolean;
    readonly type: 'TotalTasksOverall' | 'TotalTasksPerAccount';
  }

  /** @name PalletAutomationPriceError (519) */
  interface PalletAutomationPriceError extends Enum {
    readonly isInvalidTaskId: boolean;
    readonly isDuplicateTask: boolean;
    readonly isAssetNotSupported: boolean;
    readonly isAssetNotInitialized: boolean;
    readonly isAssetAlreadySupported: boolean;
    readonly isAssetAlreadyInitialized: boolean;
    readonly isInvalidAssetSudo: boolean;
    readonly isOracleNotAuthorized: boolean;
    readonly isAssetNotInTriggerableRange: boolean;
    readonly isAssetUpdatePayloadMalform: boolean;
    readonly isBlockTimeNotSet: boolean;
    readonly isInvalidAssetExpirationWindow: boolean;
    readonly isMaxTasksReached: boolean;
    readonly isMaxTasksPerAccountReached: boolean;
    readonly isTaskInsertionFailure: boolean;
    readonly isTaskRemoveFailure: boolean;
    readonly isTaskNotFound: boolean;
    readonly isInvalidTaskExpiredAt: boolean;
    readonly isTaskExpiredStorageFailedToUpdate: boolean;
    readonly isInsufficientBalance: boolean;
    readonly isLiquidityRestrictions: boolean;
    readonly isAssetLimitReached: boolean;
    readonly isFeePaymentError: boolean;
    readonly isCannotReanchor: boolean;
    readonly isUnsupportedFeePayment: boolean;
    readonly isBadVersion: boolean;
    readonly type: 'InvalidTaskId' | 'DuplicateTask' | 'AssetNotSupported' | 'AssetNotInitialized' | 'AssetAlreadySupported' | 'AssetAlreadyInitialized' | 'InvalidAssetSudo' | 'OracleNotAuthorized' | 'AssetNotInTriggerableRange' | 'AssetUpdatePayloadMalform' | 'BlockTimeNotSet' | 'InvalidAssetExpirationWindow' | 'MaxTasksReached' | 'MaxTasksPerAccountReached' | 'TaskInsertionFailure' | 'TaskRemoveFailure' | 'TaskNotFound' | 'InvalidTaskExpiredAt' | 'TaskExpiredStorageFailedToUpdate' | 'InsufficientBalance' | 'LiquidityRestrictions' | 'AssetLimitReached' | 'FeePaymentError' | 'CannotReanchor' | 'UnsupportedFeePayment' | 'BadVersion';
  }
