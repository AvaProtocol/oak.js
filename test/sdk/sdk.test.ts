...
// import type { Chain, Weight } from '@oak-network/config';
...
//     const chain = new Chain({ key: 'turing-local', assets: [turAsset], defaultAsset: turAsset, endpoint: 'ws://127.0.0.1:9946', relayChain: 'local', xcm: { network: 'rococo', instructionWeight: new Weight(new BN(1), new BN(2))} });
...
//     console.log('moonbaseAdapter: ', moonbaseAdapter);
...
//     const encodedCallWeight = await moonbaseAdapter.getExtrinsicWeight(extrinsic, '0x31C5aA398Ae12B0dc423f47D47549095aA8c93A5');
...
//   test('test-moonbase-xcmp-task-custom-execution-fee', async () => {
//     if (_.isUndefined(turingAdapter) || _.isUndefined(moonbaseApi) || _.isUndefined(moonbaseAdapter) || _.isUndefined(keyringPair) || _.isUndefined(moonbaseKeyringPair)) throw new Error("Not initialized yet");
//     // Make task payload extrinsic
//     const taskPayloadExtrinsic = moonbaseApi.tx.system.remarkWithEvent('hello!');
...
//     const encodedCallWeight = await astarAdapter.getExtrinsicWeight(extrinsic, '68TwNoCpyz1X3ygMi9WtUAaCb8Q6jWAMvAHfAByRZqMFEtJG');
...
//     const encodedCallWeight = await turingAdapter.getExtrinsicWeight(extrinsic, '68TwNoCpyz1X3ygMi9WtUAaCb8Q6jWAMvAHfAByRZqMFEtJG');
...
//     const encodedCallWeight = await mangataAdapter.getExtrinsicWeight(extrinsic, '68TwNoCpyz1X3ygMi9WtUAaCb8Q6jWAMvAHfAByRZqMFEtJG');
//     const overallWeight = await mangataAdapter.calculateXcmOverallWeight(encodedCallWeight, 6);
//     console.log('encodedCallWeight: ', encodedCallWeight);
//     console.log('overallWeight: ', overallWeight);
